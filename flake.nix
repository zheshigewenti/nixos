    ...
    commonModule = { pkgs, config, ... }: {
      ...
      users.users.vincent = {
        ...
        packages = with pkgs; [
          ...
          google-chrome clash-verge-rev qq wechat wpsoffice-cn ffmpeg-full zotero git lazygit gh ripgrep fd fastfetch steam steam-run tshark nmap hugo quickemu quickgui wget
        ];
      };
