    ...
    commonModule = { pkgs, config, ... }: {
      ...
      users.users.vincent = {
        ...
        packages = with pkgs; [
          ...
          google-chrome firefox clash-verge-rev wechat-uos qq wpsoffice-cn ffmpeg-full shotcut zotero git lazygit gh ripgrep fd fastfetch steam tshark nmap hugo
        ];
      };
